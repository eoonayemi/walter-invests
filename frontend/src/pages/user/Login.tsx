...
const LogIn = () => {
  ...
  return (
    <div>
      <div className="fixed top-0 left-0 xl:left-[30rem] right-0  xl:right-[30rem] lg:left-[25rem] lg:right-[25rem] md:left-[15rem] md:right-[15rem] text-center bg-my-blue text-white py-4 font-bold text-lg text-pretty">
